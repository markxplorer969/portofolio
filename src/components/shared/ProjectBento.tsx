...
const PROJECTS = [
  {
    title: "MarkTools",
    description: "All-in-one developer utility platform & blueprint generator.",
    tags: ["Next.js", "AI Integration", "Productivity"],
    imageUrl: "/projects/marktools.png",
    demoUrl: "https://marktools.web.id",
    repoUrl: "https://wa.me/6285883795285", // Private Contact
    featured: true, // SPAN 2x2
  },
  {
    title: "Simple Payment",
    description: "Streamlined payment gateway interface.",
    tags: ["React", "UI/UX"],
  ...
  },
  {
    ...
    description: "Official community platform for Guild Norvus.",
  ...
  },
  {
    ...
    description: "Interactive prank tool simulating calls.",
  ...
  {
    title: "QC iPhone Web",
    description: "Web-based iPhone hardware diagnostic tools.",
    tags: ["Hardware API", "Mobile"],
...
const ProjectBento = () => {
  ...
  const gridItems = [
    ...
    { type: 'project', data: PROJECTS[3] }, // Fake Call Generator
    { type: 'project', data: PROJECTS[4] }, // QC iPhone Web
